    ...
    <div class="card-body">
        <form action="{{ route('event.update', $event->id_event) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label>Judul</label>
                <input type="text" name="judul" class="form-control" placeholder="Judul.." value="{{ $event->judul }}" required>
            </div>
            <div class="form-group">
                <label>Keterangan</label>
                <input type="text" name="ket" class="form-control" placeholder="Keterangan.." value="{{ $event->ket }}" required>
            </div>
            <div class="form-group">
                <label>Isi</label>
                <textarea name="isi" class="form-control" placeholder="Isi.." required>{{ $event->isi }}</textarea>
            </div>
            <div class="form-group">
...
$(document).ready(function() {
    $("#id_pengguna").val('{{ $event->id_pengguna }}');
});
</script>
